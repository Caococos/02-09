 ...
 * @version: 1.0
 * @Author: Zhihaot1
 * @Date: 2021-06-12 21:19:27
 * @LastEditors: Zhihaot1
 * @LastEditTime: 2021-06-14 20:02:12
-->
<template>
...
export default {
  ...
  data() {
    return {
      message: [
        '阳光就像一只温暖的大手轻轻抚平你容貌上的小瑕疵',
        '洁白的大腿和蓬松的纱裙、纤细的手指和精致的蕾丝、玲珑的锁骨和长长的睫毛，是你啊',
        '对你的喜欢，就像小肚腩，藏呀，藏不住呀',
        '月色与雪色之间，你是第三种绝色',
        '逐渐变得粉色的水，那是我喜欢你的颜色',
        '我泡在你的海水里，可凉，可凉了',
  ...
  computed: {
    msg() {
      return this.message[this.random()]
    }
  }
}
</script>
